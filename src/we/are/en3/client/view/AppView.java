...
public class AppView {
    ...
    public AppView(HasWidgets container) {
        ...
        this.mainLayoutPanel.getElement().getStyle().setHeight(50,Style.Unit.EM);
        this.mainLayoutPanel.getElement().getStyle().setWidth(90,Style.Unit.EM);
